      ...
      itemBuilder: (BuildContext context, int index) {
        return new Card(
          ...
          child: InkWell(
            ...
            onTap: () => {
              ScreenNavigator().navigatePush(context, RecipeDetailsView(recipeList[index]))
            },
            child: Container(
              width: itemWidth,
              height: itemHeight,
              child: Stack(
                children: [
                  Column(
                    ...
                    children: [
                      Expanded(
                        flex: 1,
                        child: Image.network(
                          Constant.recipeBaseImageUrl + recipeList[index].image,
                          width: itemWidth,
                          fit: BoxFit.cover,
                  ...
                  Padding(
                    ...
                    child: ClipOval(
                      child: Material(
                        color: IconUtil().getIconBackground(recipeList[index].category),
                        child: SizedBox(
                          width: 32,
                          height: 32,
                          child: Icon(
                            IconUtil().getIcon(recipeList[index].category),
                            color: Colors.white,
                            size: 20,
                          ),
                        ),
